...
import 'package:front_shared/src/generated/domain/models/exercise_session.dart';
import '../helpers/database_helper.dart';

void main() {
  late AppDatabase db;
  late ExerciseSessionDao dao;
  ...
  group('ExerciseSessionDao', () {
    test('create and find by id', () async {
      final entity = ExerciseSession.create(
        trainingSessionId: 'test-trainingSessionId',
